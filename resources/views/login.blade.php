                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5 text-center">
                                        <a href="index-2.html" class="d-block auth-logo">
                                            <img src="https://www.bancoindia.com/wp-content/uploads/2017/06/logo.png" alt="" height="60">
                                        </a>
                                    </div>
                                    <div class="auth-content my-auto">
                                        <div class="text-center">
                                            <h5 class="mb-0">Welcome Back !</h5>
                                            <p class="text-muted mt-2">Sign in to continue to Banco.</p>
                                        </div>
                                        <form class="mt-4 pt-2" action="/login" method="post">
                                            @csrf
                                            <div class="form-floating form-floating-custom mb-4">
                                                <input type="email" name="email" class="form-control" id="input-username" placeholder="Enter User Name" required>
                                            ...
                                            <div class="carousel-inner">
                                                <div class="carousel-item active">
                                                    <div class="testi-contain text-center text-white">
                                                        ...
                                                        <h4 class="mt-4 fw-medium lh-base text-white">“Success is not the key to happiness. Happiness is the key to success. If you love what you are doing, you will be successful.”
                                                        </h4>
                                                        <div class="mt-4 pt-1 pb-5 mb-5">
                                                            <h5 class="font-size-16 text-white">Albert Schweitzer
                                                            </h5>
                                                            <p class="mb-0 text-white-50">Nobel Prize Winner</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="carousel-item">
                                                    <div class="testi-contain text-center text-white">
                                                        <i class="bx bxs-quote-alt-left text-success display-6"></i>
                                                        <h4 class="mt-4 fw-medium lh-base text-white">“The only way to do great work is to love what you do. If you haven't found it yet, keep looking. Don't settle.”</h4>
                                                        <div class="mt-4 pt-1 pb-5 mb-5">
                                                            <h5 class="font-size-16 text-white">Steve Jobs
                                                            </h5>
                                                            <p class="mb-0 text-white-50">Co-founder of Apple Inc.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="carousel-item">
                                                    <div class="testi-contain text-center text-white">
                                                        <i class="bx bxs-quote-alt-left text-success display-6"></i>
                                                        <h4 class="mt-4 fw-medium lh-base text-white">“The only thing worse than training employees and losing them is not training them and keeping them.”</h4>
                                                        <div class="mt-4 pt-1 pb-5 mb-5">
                                                            <h5 class="font-size-16 text-white">Zig Ziglar</h5>
                                                            <p class="mb-0 text-white-50">Author and Motivational Speaker
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
